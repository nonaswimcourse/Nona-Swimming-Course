...
function exportSiswaPDF(index) {
    ...
    try {
        // Menggambar Header Berbentuk Box Biru Elegan (Pengganti Gambar Logo yang Merusak)
        doc.setFillColor(35, 74, 132);
        doc.rect(14, 10, 182, 28, "F");

        doc.setFont("Helvetica", "bold");
        doc.setFontSize(14);
        doc.setTextColor(255, 255, 255);
        doc.text("LAPORAN ABSENSI INDIVIDU SISWA", 20, 22); 
        
        doc.setFontSize(11);
        doc.setFont("Helvetica", "normal");
        doc.setTextColor(241, 245, 249);
        doc.text("NONA SWIMMING COURSE (NSC)", 20, 30);
        ...
        doc.autoTable({ 
            ...
            styles: { textColor: [71, 85, 105], fontSize: 10, cellPadding: 5 },
...
function exportTotalPDF() {
    ...
    try {
        // Menggambar Header Box Biru Elegan
        doc.setFillColor(35, 74, 132);
        doc.rect(14, 10, 182, 28, "F");
        ...
        doc.setFontSize(14); 
        doc.setTextColor(255, 255, 255);
        doc.text("LAPORAN REKAP TOTAL KEHADIRAN", 20, 22);
        
        doc.setFontSize(10);
        doc.setFont("Helvetica", "normal");
        doc.setTextColor(241, 245, 249);
        doc.text(`Nona Swimming Course - Total Target: ${TOTAL_PERTEMUAN} Pertemuan`, 20, 30);
        ...
        console.error(e);
        alert("Gagal memproses PDF Total.");
    }
}
